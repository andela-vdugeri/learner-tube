 ...
 <ul id="nav-mobile" class="right hide-on-med-and-down">
	...
	<ul id="profile" class="dropdown-content collection">
	 <li><a href="{{ route('dashboard') }}" class="collection-item" id="edit-profile">Dashboard</a></li>
	 <li><a href="{{ route('profile.edit', $user->id) }}" class="collection-item" id="edit-profile">Edit profile</a></li>
